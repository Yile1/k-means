...
def initMethodTest():
    ...
    x_train = data[[0, 1, 2, 3]].values.reshape(numOfData, 4)
    ...
    pltShow(data, 0, 1, 4, closerstCenter1, center1, iris_types)
    pltShow(data, 0, 1, 4, closerstCenter2, center2, iris_types)
    pltShow(data, 0, 1, 4, closerstCenter3, center3, iris_types)
...
def kTest():
    ...
    J2 = np.zeros((len, 1))
    J3 = np.zeros((len, 1))
    x_train = data[[0, 1, 2, 3]].values.reshape(data.shape[0], 4)
